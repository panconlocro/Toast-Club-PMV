...
from .api.v1 import sessions, recordings, surveys, auth, dataset, texts, admin_users
...
app.include_router(admin_users.router, prefix=settings.API_V1_STR, tags=["admin"])
